...
class Facebook_WP_Extend_Ai1ec extends WP_Facebook_Ai1ec {
	...
	protected function setPersistentData( $key, $value ) {
		...
		// load user functions
		if ( ! class_exists( 'Ai1ec_Facebook_User' ) )
			require_once( dirname(__FILE__) . '/facebook-user.php' );
		Ai1ec_Facebook_User::update_user_meta( get_current_user_id(), $key, $value );
	}
	...
	protected function getPersistentData( $key, $default = false ) {
		...
		if ( ! class_exists( 'Ai1ec_Facebook_User' ) )
			require_once( dirname(__FILE__) . '/facebook-user.php' );
		return Ai1ec_Facebook_User::get_user_meta( get_current_user_id(), $key, true );
	}
	...
	protected function clearPersistentData( $key ) {
		...
		if ( ! class_exists( 'Ai1ec_Facebook_User' ) )
			require_once( dirname(__FILE__) . '/facebook-user.php' );
		Ai1ec_Facebook_User::delete_user_meta( get_current_user_id(), $key );
	}
