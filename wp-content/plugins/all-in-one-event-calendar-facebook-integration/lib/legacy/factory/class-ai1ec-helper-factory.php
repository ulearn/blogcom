...
class Ai1ec_Helper_Factory {
	 ...
	 * @param array $args
	 * 
	 * @return Ai1ec_Bootstrap_Radio
	 */
	public static function create_bootstrap_radio_instance( $label, $name, $id, array $args = array() ) {
		return new Ai1ec_Bootstrap_Radio( $label, $name, $id, $args );
	}
}
