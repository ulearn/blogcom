...
class Ai1ec_Facebook_Group_Query_Events_Strategy extends Ai1ec_Facebook_Query_Abstract implements Query_Events_Strategy_Interface {
	 ...
	 */
	public function query_events( Ai1ec_Facebook_Proxy $facebook, array $groups, $timestamp ) {
		$events = array();
		try {
	 ...
	 *
	 * @param Ai1ec_Facebook_Proxy $facebook a Facebook instance
	 *
	 ...
	 */
	private function get_events_eid_from_groups( Ai1ec_Facebook_Proxy $facebook, array $groups ) {
		$group_events = array();
	 ...
	 */
	private function get_events_from_facebook_from_eids( Ai1ec_Facebook_Proxy $facebook, array $grouped_eids, $timestamp ) {
