...
<div class="ai1ec-facebook-subscriber ai1ec-facebook-items ai1ec-well ai1ec-well-sm ai1ec-pull-left" data-type="$type">
	<img id="profile-img" class="ai1ec-facebook-pic ai1ec-pull-left" alt="$alt_img" src="https://graph.facebook.com/$username/picture" />
HTML;
	...
	private function render_multiselects( array $types, $current_id ) {
		...
		$category_select = $factory->create_select2_multiselect(
			array(
				...
				'use_id'      => true,
				'type'        => 'category',
				'placeholder' => __( 'Categories (optional)', AI1EC_PLUGIN_NAME ),
				'class'       => 'categories'
			),
		...
		foreach ( $types as $type ) {
			...
			$html .= <<<HTML
<div class="ai1ec-col-sm-4 ai1ec-facebook-multiselect-container" data-type="$type">
